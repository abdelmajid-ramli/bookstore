...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i <= 50; $i++) {
            ...
            //associating the livre with authors and genres
            for ($j = 0; $j < $faker->numberBetween(1, 3); $j++) {
                $livre->addAuteur($this->getReference($this->auteur_ref . '-' . $faker->numberBetween(0, 19)));
        ...
        $admin = new User();
        $admin->setEmail('ramli@gmail.com');
